...
i.on_mouse_drag=i.on_mouse_motion=lambda a,o,m,_=s(),b=glLineWidth(2),i=i.set_mouse_cursor(i.get_system_mouse_cursor("crosshair")),n=(1,1,6407,5122,(GLint*3)()):r or(l.extend((a,o))or len(l)>3and((lambda e:any(glReadPixels(*(p,(a,o)[e]+(p-l[-1-e])*(l[e-4]-l[e-2])/(l[-3-e]-l[-1-e]))[::e-1+e]+n)or n[4][1-1]for p in range((o,a)[e],l[-3-e],cmp(*l[-3-e::2]))))(abs(l[-4]-l[-2])>abs(l[-3]-l[-1])))and(g(r=p,c=e)or n[4][1])and s())
app.run()